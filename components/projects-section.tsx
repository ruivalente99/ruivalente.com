  ...
  return (
    <Card className="h-full p-4 flex flex-col justify-between" role="region" aria-labelledby="featured-projects-heading">
      <header className="flex items-center justify-between mb-3">
        <h2 id="featured-projects-heading" className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">
          featured projects
        </h2>
        <Button 
          variant="ghost" 
              ...
              <div className="flex items-center justify-between pt-1 border-t border-border/30">
                <div className="flex items-center gap-1.5 relative z-10">
                  <a
                    ...
                    className="h-7 px-2.5 rounded-lg bg-background/80 hover:bg-background border border-border/50 text-[11px] font-medium flex items-center gap-1 text-foreground/80 hover:text-foreground transition-all duration-150 active:scale-[0.94] shadow-2xs focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                ...
                <ArrowRight className="w-3.5 h-3.5 opacity-40 group-hover:opacity-100 group-hover:translate-x-0.5 transition-all text-foreground pointer-events-none" aria-hidden="true" />
              </div>
            </div>
          </article>
        ))}
